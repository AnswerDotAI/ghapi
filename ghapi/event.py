...
# %% ../04_event.ipynb #49b5c97b
def _id2int(x):
    x.id = int(x.id)
    return x

# %% ../04_event.ipynb #2191a4b9
@patch
...
# %% ../04_event.ipynb #1b01c937
def _cast_evt(o): return globals()[o.type](o)

# %% ../04_event.ipynb #00e8ab14
@patch
@delegates(_list_events)
