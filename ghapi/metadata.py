funcs = [('/', 'get', 'meta/root', 'GitHub API Root', 'rest/meta/meta#github-api-root', [], [], ''),
 ...
 ('/enterprises/{enterprise}/code-security/configurations/{configuration_id}/repositories',
  ...
  [],
  ''),
 ('/enterprises/{enterprise}/dependabot/alerts', 'get', 'dependabot/list-alerts-for-enterprise', 'List Dependabot alerts for an enterprise', 'rest/dependabot/alerts#list-dependabot-alerts-for-an-enterprise', ['state', 'severity', 'ecosystem', 'package', 'epss_percentage', 'has', 'scope', 'sort', 'direction', 'before', 'after', 'per_page'], [], ''),
 ...
 ('/orgs/{org}/dependabot/alerts',
  ...
  ['state', 'severity', 'ecosystem', 'package', 'epss_percentage', 'artifact_registry_url', 'artifact_registry', 'has', 'runtime_risk', 'scope', 'sort', 'direction', 'before', 'after', 'per_page'],
  [],
  ''),
 ...
 ('/orgs/{org}/properties/schema/{custom_property_name}',
  ...
  [],
  [['value_type', str], ['required', bool], ['default_value', object], ['description', str], ['allowed_values', list], ['values_editable_by', str]],
  ''),
 ...
 ('/repos/{owner}/{repo}/dependabot/alerts', 'get', 'dependabot/list-alerts-for-repo', 'List Dependabot alerts for a repository', 'rest/dependabot/alerts#list-dependabot-alerts-for-a-repository', ['state', 'severity', 'ecosystem', 'package', 'manifest', 'epss_percentage', 'has', 'scope', 'sort', 'direction', 'per_page', 'before', 'after'], [], ''),
