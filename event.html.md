...
<a href="https://github.com/fastai/ghapi/blob/main/ghapi/event.py#L47"
...
def list_events(
    per_page:int=30, page:int=1, username:NoneType=None, org:NoneType=None, owner:NoneType=None, repo:NoneType=None
):
...
<a href="https://github.com/fastai/ghapi/blob/main/ghapi/event.py#L55"
target="_blank" style="float:right; font-size:smaller">source</a>
...
def list_events_parallel(
    per_page:int=30, n_pages:int=8, username:NoneType=None, org:NoneType=None, owner:NoneType=None,
    repo:NoneType=None
):
...
<a href="https://github.com/fastai/ghapi/blob/main/ghapi/event.py#L68"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a href="https://github.com/fastai/ghapi/blob/main/ghapi/event.py#L91"
target="_blank" style="float:right; font-size:smaller">source</a>
...
def fetch_events(
    n_pages:int=3, pause:float=0.4, per_page:int=30, types:NoneType=None, incl_bot:bool=False,
    username:NoneType=None, org:NoneType=None, owner:NoneType=None, repo:NoneType=None
):
...
<a href="https://github.com/fastai/ghapi/blob/main/ghapi/event.py#L104"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a href="https://github.com/fastai/ghapi/blob/main/ghapi/event.py#L115"
target="_blank" style="float:right; font-size:smaller">source</a>
